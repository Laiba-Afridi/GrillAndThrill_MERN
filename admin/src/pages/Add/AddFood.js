...
//       <p>Product Name</p>
//       <input onChange={onChangeHandler} value={data.name} type='text' name='name' placeholder='Enter Name Here'></input>
//        </div>

//        <div className='add-desp flex-col'>
//       <p>Product Description</p>
//       <textarea onChange={onChangeHandler} value={data.description} name='description' rows='6' placeholder='Enter Description Here' required></textarea>
//        </div>
...
//       <option value="Beef Bugrer">Beef Bugrer</option>
//       <option value="Loaded fries">Loaded fries</option>
//       <option value="Buger Deals">Buger Deals</option>
//       <option value="Bevarges Deals">Bevarges Deals</option>
...
//        <p>Product Price</p>
//        <input onChange={onChangeHandler} value={data.price} type='number' name='price' placeholder='RS 1000'></input>
//        </div>
//       </div>

//        <button type='submit' className='add-bt'>Add Product</button>
//       </form>
//     </div>
//   )
// }
        ...
        <div className="add-cat-price">
          <div className="add-category flex-col">
            ...
            <select onChange={onChangeHandler} name="category">
              ...
              <option value="Beverages Deals">Beverages Deals</option>
              <option value="Chicken Nuggets">Chicken Nuggets</option>
            </select>
          </div>
